...
export default function ResultadoEtapa7() {
  ...
  async function handleEnviarMensagem(mensagem) {
    const resp = await corrigirEtapa(sessionId, 7, mensagem);
  ...
  return (
    <div className="min-h-screen bg-am-bg p-5">
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <Card>
          <p className="text-base font-semibold text-am-navy mb-3.5">Recomendações finais</p>
          <Stepper
            etapaAtual={7}
